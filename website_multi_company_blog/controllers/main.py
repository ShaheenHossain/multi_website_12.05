...
from eagle import SUPERUSER_ID, http
from eagle.http import request
from eagle.tools.safe_eval import safe_eval

from eagle.addons.website_blog.controllers.main import WebsiteBlog


# we use this hack
# after domain field in ir.rule was removed
# https://github.com/eagle/eagle/commit/172a767e5f7add9c5e806e00e0146dc5f09e806b#diff-e487de633a7ef116c20a824d203973a3
